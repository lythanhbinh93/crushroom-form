...
status: in-progress
progress: "Phases 01-02 SHIPPED 2026-05-14. Theme commits 9612985 + 1ca4000. QA 30/30 (P01) + 48/49 (P02, 1 P1 LCP flag). 16 theme blocks live (10 dop-* + 6 migrated). Phases 03-07 remain."
priority: P1
...
| 02 | [Homepage template (home-hero, manifesto, newsletter + accept @theme on already-blocked)](phase-02-homepage-template.md) ✅ | 4-6h (actual ~2.5h) | **PASS** — 48/49 (P1 LCP flag) |
