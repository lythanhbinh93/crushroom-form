...
| 5 | [Products Columns + Creatives Cockpit](./phase-05-products-columns-and-creatives-cockpit.md) | Pending | 12-15h | 0020 (ALTER creative cache) |
...
| 0020 | 05 | `ALTER meta_ad_creative_cache ADD creative_id, creative_type, image_hash, permanent_url, thumbnail` (no new table) |
